    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center">
          ...
          >
            Full Stack Developer • Data Analyst • DevOps Engineer • Legal Expert • Business Consultant
          </motion.p>
          ...
          >
            Menguasai berbagai teknologi programming, data analysis, hukum, matematika, 
            hingga layanan desain rumah dan jual beli mobil premium
          </motion.p>
